...
try:
    ...
    env = make_env(
        ...
        dict_spaces=True,
        wrapper=Wrapper.SKRL_SINGLE_AGENT_VEC,
        max_steps=200,
        n_agents=1,
        terminated_truncated=True,
    )
except ImportError:
    raise ImportError("VMAS is not installed. Please install it with `pip install vmas`.")
env = wrap_env(env)
...
cfg["experiment"]["directory"] = "runs/torch/VmasSAC"
